        ...
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              We've provided{' '}
              <span sx={{ background: `url(${paint1})` }}>up to 255</span> mouthwatering meals for{' '}
              <span sx={{ background: `url(${paint2})` }}>100</span> people
              throughout Ukraine.
            </Heading>
            <Text as="p" sx={styles.summary}>
              Sample any kind of food with our versatile chefs. We approach all the needs and wishes of our customers.
            </Text>
